...
// Messaggi ufficiali AgID (Tabella Anomalie v1.3)
const SPID_ERROR_MESSAGES = {
  spid_error_19:     'Anomalia 19 — Credenziali errate ripetutamente. Riprova più tardi.',
  spid_error_20:     'Anomalia 20 — Credenziali non compatibili con il livello richiesto.',
  spid_error_21:     'Anomalia 21 — Sessione di autenticazione scaduta.',
  spid_error_22:     'Anomalia 22 — Consenso attributi negato dall\'utente.',
  spid_error_23:     'Anomalia 23 — Credenziali SPID temporaneamente bloccate.',
  spid_error_25:     'Anomalia 25 — Autenticazione annullata dall\'utente.',
  spid_authn_failed: 'Autenticazione SPID fallita. Riprova.',
  spid_no_authn_context: 'Livello di autenticazione non soddisfatto.',
  no_user:           'Nessun profilo SPID ricevuto. Riprova.',
...
export function LoginView({ onLogin }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      notify.error('Credenziali non valide');
    } finally {
      setLoading(false);
    }
  };

  // Legge eventuale errore SPID dalla query string
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: 380, boxShadow: '0 4px 24px rgba(0,0,0,.12)'
      }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {/* Separatore + bottone SPID subito sotto Accedi */}
          <div style={{ display: 'flex', alignItems: 'center', margin: '4px 0 16px' }}>
            <div style={{ flex: 1, height: 1, background: '#e5e7eb' }} />
            <span style={{ margin: '0 12px', color: '#9ca3af', fontSize: '0.82rem' }}>
              oppure accedi con
            </span>
            <div style={{ flex: 1, height: 1, background: '#e5e7eb' }} />
          </div>
